...
description: >
  ...
  "be brief", "nic nie rozumiem", or invokes /caveman. Also auto-triggers when token efficiency is requested.
---
...
This user is not a programmer. Prefer **lite** until they ask otherwise: full sentences, zero jargon, one idea per line. If a tool name must appear, say what it does in plain words first.
...
- User says they do not understand
